    ...
    config = function()
        ...
        vim.api.nvim_create_autocmd("LspAttach", {
            ...
            callback = function(ev)
                ...
                keymap.set("n", "cs", vim.lsp.buf.signature_help,
                    vim.tbl_extend("force", opts, { desc = "Signature help" }))

                -- LSP navigation (FzfLua)
                keymap.set("n", "fcd", "<cmd>FzfLua lsp_definitions<CR>",
                    vim.tbl_extend("force", opts, { desc = "Go to definition (FzfLua)" }))
                keymap.set("n", "cd", vim.lsp.buf.declaration,
                    vim.tbl_extend("force", opts, { desc = "Go to declaration" }))
                keymap.set("n", "fci", "<cmd>FzfLua lsp_implementations<CR>",
                    vim.tbl_extend("force", opts, { desc = "Go to implementation (FzfLua)" }))
                keymap.set("n", "fco", "<cmd>FzfLua lsp_type_definitions<CR>",
                    vim.tbl_extend("force", opts, { desc = "Go to type definition (FzfLua)" }))
                keymap.set("n", "fcr", "<cmd>FzfLua lsp_references<CR>",
                    vim.tbl_extend("force", opts, { desc = "Show references (FzfLua)" }))

                -- Diagnostics
                keymap.set("n", "<leader>fcd",
                ...
                -- Restart LSP
                keymap.set("n", "<leader>crs", "<cmd>LspRestart<CR>",
