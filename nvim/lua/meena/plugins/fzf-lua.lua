return {
    {
        ...
        config = function()
            ...
            km.set("n", "<Leader><leader>rf", fzf.resume, { desc = "Resume last FZF search" })
            ...
            -- LSP and symbols
            km.set("n", "<Leader>fds", ":lua require'fzf-lua'.lsp_document_symbols({winopts = {preview={wrap='wrap'}}})<cr>", { desc = "Search document symbols" })
            ...
            -- Git
            km.set("n", "<Leader>ffgs", fzf.git_status, { desc = "Show Git status" })
            km.set("n", "<Leader>ffgb", fzf.git_branches, { desc = "Show Git branches" })
        end,
    },
}
